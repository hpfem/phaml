...
!
! This version illustrates solving a nonlinear equation with Picard iteration.
! It solves uxx + uyy = -exp(u) with homogeneous Dirichlet b.c. on the unit sq.
!----------------------------------------------------
...
! use an initial guess of 1.0 for the nonlinear problem
