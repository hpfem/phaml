...
echo "	$MAIN.o pde.o "'\' 1>>$f
if [ -n "$SUPERLULIBS" -o -n "$HYPRELIBS" -o -n "$ZOLTANLIBS" -o -n "$ARPACKLIBS" -o -n "$PETSCLIBS" -o -n "$MUMPSLIBS" -o -n "$LAPACKLIBS" -o -n "$BLASLIBS" -o -n "$MESSPASSLIBS" -o -n "$PHAML_GETS_GRAPHICSLIBS" -o -n "$OTHERLIBS" ]
then
echo "	"'-L$(PHAML_LIBDIR) -lphaml \' 1>>$f
else
echo "	"'-L$(PHAML_LIBDIR) -lphaml' 1>>$f
...
if [ -n "$SUPERLULIBS" ]
then
   if [ -n "$HYPRELIBS" -o -n "$ZOLTANLIBS" -o -n "$ARPACKLIBS" -o -n "$PETSCLIBS" -o -n "$MUMPSLIBS" -o -n "$LAPACKLIBS" -o -n "$BLASLIBS" -o -n "$MESSPASSLIBS" -o -n "$PHAML_GETS_GRAPHICSLIBS" -o -n "$OTHERLIBS" ]
   then
echo "	$SUPERLULIBS "'\' 1>>$f
   else
echo "	$SUPERLULIBS " 1>>$f
...
if [ -n "$HYPRELIBS" ]
then
   if [ -n "$ZOLTANLIBS" -o -n "$ARPACKLIBS" -o -n "$PETSCLIBS" -o -n "$MUMPSLIBS" -o -n "$LAPACKLIBS" -o -n "$BLASLIBS" -o -n "$MESSPASSLIBS" -o -n "$PHAML_GETS_GRAPHICSLIBS" -o -n "$OTHERLIBS" ]
   then
echo "	$HYPRELIBS "'\' 1>>$f
   else
echo "	$HYPRELIBS " 1>>$f
...
if [ -n "$ZOLTANLIBS" ]
then
   if [ -n "$ARPACKLIBS" -o -n "$PETSCLIBS" -o -n "$MUMPSLIBS" -o -n "$LAPACKLIBS" -o -n "$BLASLIBS" -o -n "$MESSPASSLIBS" -o -n "$PHAML_GETS_GRAPHICSLIBS" -o -n "$OTHERLIBS" ]
   then
echo "	$ZOLTANLIBS "'\' 1>>$f
   else
echo "	$ZOLTANLIBS " 1>>$f
...
if [ -n "$ARPACKLIBS" ]
then
   if [ -n "$PETSCLIBS" -o -n "$MUMPSLIBS" -o -n "$LAPACKLIBS" -o -n "$BLASLIBS" -o -n "$MESSPASSLIBS" -o -n "$PHAML_GETS_GRAPHICSLIBS" -o -n "$OTHERLIBS" ]
   then
echo "	$ARPACKLIBS "'\' 1>>$f
   else
echo "	$ARPACKLIBS " 1>>$f
