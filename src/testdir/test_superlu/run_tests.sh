...
# Script to run PHAML tests of SuperLU

THISDIR="test_superlu"
echo "PHAML TEST:"
echo "PHAML TEST: $THISDIR: tests of SuperLU"

if [ $PHAML_SUPERLU = "no" ]
then
   echo "PHAML TEST:"
   echo "PHAML TEST: SuperLU not included in PHAML compilation"
