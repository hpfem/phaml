...
# Script to run PHAML tests of refinement strategies and options

THISDIR="test_refinement"
echo "PHAML TEST:"
echo "PHAML TEST: $THISDIR: tests of refinement strategies and options"
