...
# Script to run PHAML tests of domain generation

THISDIR="test_domain"
echo "PHAML TEST:"
echo "PHAML TEST: $THISDIR: tests of domain generation"

which triangle >& /dev/null
PASS=$?
if [ $PASS != 0 ]
then
   echo "PHAML TEST:"
   echo "PHAML TEST: triangle is not in the directories listed in PATH"
