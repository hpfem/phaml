...
# Script to run PHAML tests of BLOPEX with PETSc

THISDIR="test_blopexp"
echo "PHAML TEST:"
echo "PHAML TEST: $THISDIR: tests of BLOPEX with PETSc"

if [ $PHAML_BLOPEX != "withpetsc" ]
then
   echo "PHAML TEST: PHAML compiled without BLOPEX via PETSc"
