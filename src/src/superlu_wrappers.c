...
#define f_set_default_options_dist       f_set_default_options_dist
...
#define f_dCreate_CompRowLoc_Matrix_dist f_dcreate_comprowloc_matrix_dis
#define f_Destroy_CompRowLoc_Matrix_dist f_destroy_comprowloc_matrix_dis
...
#define f_set_default_options_dist       f_set_default_options_dist_
...
#define f_dCreate_CompRowLoc_Matrix_dist f_dcreate_comprowloc_matrix_dis_
#define f_Destroy_CompRowLoc_Matrix_dist f_destroy_comprowloc_matrix_dis_
...
#define f_set_default_options_dist       f_set_default_options_dist__
...
#define f_dCreate_CompRowLoc_Matrix_dist f_dcreate_comprowloc_matrix_dis__
#define f_Destroy_CompRowLoc_Matrix_dist f_destroy_comprowloc_matrix_dis__
...
{
   *handle = (fptr) malloc(sizeof(gridinfo_t));
}

void f_create_options(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(superlu_options_t));
}

void f_create_ScalePermstruct(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(ScalePermstruct_t));
}

void f_create_LUstruct(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(LUstruct_t));
}

void f_create_SOLVEstruct(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(SOLVEstruct_t));
}

void f_create_SuperMatrix(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(SuperMatrix));
}

void f_create_SuperLUStat(fptr *handle)
{
   *handle = (fptr) malloc(sizeof(SuperLUStat_t));
}
...
void f_set_default_options_dist(fptr *options)
{
